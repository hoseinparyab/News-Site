<div class="navbar-custom">
    <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <li class="dropdown notification-list">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-lg">
                ...
                <div class="slimscroll noti-scroll">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <div class="notify-icon">
                            <img src="/admin/images/users/user-4.jpg" class="img-fluid rounded-circle" alt="تصویر" />
                        </div>
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#"
                ...
                <img src="/admin/images/users/user-1.jpg" alt="تصویر کاربر" class="rounded-circle">
    ...
    <div class="logo-box">
        <a href="index-2.html" class="logo text-center">
            <span class="logo-lg">
                <img src="/admin/images/logo-dark.png" alt="تصویر" height="16">
                <!-- <span class="logo-lg-text-light">Xeria</span> -->
            </span>
            <span class="logo-sm">
                <!-- <span class="logo-sm-text-dark">X</span> -->
                <img src="/admin/images/logo-sm.png" alt="تصویر" height="24">
            </span>
        </a>
    </div>
