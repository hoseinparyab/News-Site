                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control @error('status') is-invalid @enderror" name="status">
                                                @foreach (PYB\Article\Models\Article::$statuses as $status)
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control @error('type') is-invalid @enderror" name="type">
                                                @foreach (PYB\Article\Models\Article::$types as $type)
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control @error('type_text') is-invalid @enderror" name="type_text">
                                                ...
                                                @foreach (\PYB\Article\Enums\TypeTextArticleEnum::cases() as $type)
